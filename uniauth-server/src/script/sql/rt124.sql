...
ALTER TABLE cfg COMMENT='系统定制化配置表';
ALTER TABLE cfg_type COMMENT='定制化配置的code';
ALTER TABLE `domain` COMMENT='集成系统表';
ALTER TABLE grp COMMENT='组';
ALTER TABLE grp_path COMMENT='组与组之间层级关系表';
ALTER TABLE grp_role COMMENT='组与角色之间的关联关系表';
ALTER TABLE grp_tag COMMENT='组与tag之间的关联关系表';
ALTER TABLE permission COMMENT='权限表';
ALTER TABLE perm_type COMMENT='权限类别表';
ALTER TABLE role COMMENT='角色表';
ALTER TABLE role_code COMMENT='角色对应的code枚举表,用于springsecurity hasRole';
