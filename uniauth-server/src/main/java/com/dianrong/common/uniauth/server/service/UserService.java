...
public class UserService extends TenancyBasedService implements UserAuthentication {
  ...
  public UserDto addNewUser(String name, String phone, String email) {
    return userInnerService.addNewUser(name, phone, email);
  }
  ...
  public UserDto updateUser(UserActionEnum userActionEnum, Long id, String account, Long tenancyId,
    ...
    return userInnerService.updateUser(userActionEnum, id, account, tenancyId, name, phone, email,
        password, orginPassword, ignorePwdStrategyCheck, status);
  }
  ...
  public UserDetailDto getUserDetailInfoByUid(Long paramUserId) {
    User user = userInnerService.getUserByPrimaryKey(paramUserId);
    if (user == null) {
      return null;
    }
  ...
  public void resetPassword(UserParam userParam) {
    userInnerService.resetPassword(userParam);
  }
  ...
  public User getUserByAccount(String account, String tenancyCode, Long tenancyId,
    ...
    return userInnerService.getUserByAccount(account, tenancyCode, tenancyId, withPhoneChecked, status);
  }
  ...
  public User getUserByIdentity(String identity, UserIdentityType identityType) {
    return userInnerService.getUserByIdentity(identity, identityType);
  }
