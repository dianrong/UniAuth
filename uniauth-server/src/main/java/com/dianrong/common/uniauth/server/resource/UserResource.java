 ...
 */
@Api("用户信息操作接口") @RestController public class UserResource implements IUserRWResource {
  ...
  @ApiOperation("根据条件分页查询用户信息") @ApiImplicitParams(value = {
      @ApiImplicitParam(name = "name", value = "用户姓名(模糊匹配)", dataType = "string", paramType = "query"),
      @ApiImplicitParam(name = "phone", value = "用户电话(模糊匹配)", dataType = "string", paramType = "query"),
      @ApiImplicitParam(name = "exactPhone", value = "用户电话(精确匹配)", dataType = "string", paramType = "query"),
      @ApiImplicitParam(name = "email", value = "用户邮箱(模糊匹配)", dataType = "string", paramType = "query"),
      @ApiImplicitParam(name = "exactEmail", value = "用户邮箱(精确匹配)", dataType = "string", paramType = "query"),
  ...
  @Override @Timed public Response<PageDto<UserDto>> searchUser(UserQuery userQuery) {
  ...
  @Override @Timed public Response<UserDetailDto> getUserDetailInfo(LoginParam loginParam) {
    UserDetailDto userDetailDto = delegateUserAuthentication.getUserDetailInfo(loginParam);
    return new Response<UserDetailDto>(userDetailDto);
  }

  @Override @Timed public Response<UserDto> getSingleUser(UserParam userParam) {
    return new Response<UserDto>(userService.getSingleUser(userParam));
  }

  @Override @Timed public Response<UserDto> getUserInfoByUserTag(LoginParam loginParam) {
  ...
  @Override public Response<List<UserDto>> getUsersByGroupCodeRoleIds(UserParam userParam) {
    return Response.success(userService
        .getUsersByGroupCodeRoleIds(userParam.getGroupCode(), userParam.getIncludeSubGrp(),
  ...
  @Override @Timed public Response<VPNLoginResult> vpnLogin(LoginParam loginParam) {
  ...
  @ResourceAudit @ApiOperation("更新用户关联的IPA账号.在更新之前需要验证IPA账号和密码是否正确.") @ApiImplicitParams(value = {
      ...
      @ApiImplicitParam(name = "ipaPassword", value = "IPA密码", required = true, dataType = "string", paramType = "query")})
  @Override public Response<Void> updateUserIPAAccount(UserParam userParam) {
