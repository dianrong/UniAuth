...
public class GroupResource implements IGroupRWResource {
  ...
  @ApiOperation("根据查询条件分页查询组信息") @ApiImplicitParams(value = {
      ...
      @ApiImplicitParam(name = "name", value = "组名称", dataType = "string", paramType = "query"), @ApiImplicitParam(name = "code", value = "组code", dataType = "string", paramType = "query"),
  ...
  @Override @Timed public Response<PageDto<GroupDto>> queryGroup(GroupQuery groupQuery) {
    PageDto<GroupDto> groupDtoPageDto = groupService.searchGroup(groupQuery.getUserGroupType(),
        groupQuery.getUserId(), groupQuery.getRoleId(), groupQuery.getId(), groupQuery.getGroupIds(), groupQuery.getName(), groupQuery.getCode(),
        groupQuery.getDescription(), groupQuery.getStatus(), groupQuery.getTagId(), groupQuery.getNeedTag(), groupQuery.getNeedUser(), groupQuery.getNeedParentId(),
        groupQuery.getPageNumber(), groupQuery.getPageSize());
    return Response.success(groupDtoPageDto);
  }

  @ApiOperation(value = "根据条件以树的形式返回组信息") @ApiImplicitParams(value = {
      @ApiImplicitParam(name = "tenancyId", value = "租户id(或租户code)", required = true, dataType = "long", paramType = "query"),
  ...
  @Override @Timed public Response<GroupDto> getGroupTree(GroupParam groupParam) {
  ...
  @ApiOperation(value = "根据组Id或者Code查询组信息") @ApiImplicitParams(value = {@ApiImplicitParam(name = "id", value = "根组id", dataType = "long", paramType = "query"),
  ...
  @Override public Response<List<GroupDto>> getGroupTreeByIdOrCode(GroupParam groupParam) {
    List<GroupDto> groupDtos = groupService.getGroupTreeByIdOrCode(groupParam.getId(), groupParam.getCode(), groupParam.getUserGroupType(), groupParam.getUserStatus());
  ...
  @Override public Response<Void> addUsersIntoGroup(UserListParam userListParam) {
  ...
  @ApiOperation(value = "删除用户与组的关联关系") @ApiImplicitParams(value = {
      ...
      @ApiImplicitParam(name = "normalMember", value = "普通关联关系(或owner关系)", dataType = "boolean", paramType = "query", defaultValue = "true"),})
  @Override public Response<Void> removeUsersFromGroup(UserListParam userListParam) {
  ...
  @Override public Response<GroupDto> addNewGroupIntoGroup(GroupParam groupParam) {
  ...
  @Override public Response<GroupDto> updateGroup(GroupParam groupParam) {
  ...
  @Override public Response<Void> saveRolesToGroup(GroupParam groupParam) {
    groupService.saveRolesToGroup(groupParam.getId(), groupParam.getRoleIds());
    return Response.success();
  }

  @ApiOperation(value = "判断某个用户与某(些)组是否存在owner关系") @ApiImplicitParams(value = {
  ...
  @Override public Response<Void> checkOwner(GroupParam groupParam) {
    groupService.checkOwner(groupParam.getOpUserId(), groupParam.getTargetGroupIds(), groupParam.getTargetGroupId());
    return Response.success();
  }
  ...
  @Override public Response<Void> replaceRolesToGroup(GroupParam groupParam) {
    groupService.replaceRolesToGroupUnderDomain(groupParam.getId(), groupParam.getRoleIds(),
        groupParam.getDomainId());
    return Response.success();
  }

  @ApiOperation(value = "查询与组关联的所有的标签信息的列表") @ApiImplicitParams(value = {
      @ApiImplicitParam(name = "id", value = "组id", required = true, dataType = "long", paramType = "query"),
      @ApiImplicitParam(name = "domainId", value = "域id", required = true, dataType = "long", paramType = "query")})
  ...
  @Override public Response<Void> replaceTagsToGrp(GroupParam groupParam) {
  ...
  @Override public Response<Void> moveGroup(GroupParam groupParam) {
    groupService.moveGroup(groupParam.getId(), groupParam.getTargetGroupId());
    return Response.success();
  }

  @ApiOperation(value = "判断用户是否与某个组或其子组有关联关系") @ApiImplicitParams(value = {
      @ApiImplicitParam(name = "tenancyId", value = "租户id(或租户code)", required = true, dataType = "long", paramType = "query"),
  ...
  @ApiOperation(value = "根据用户id获取用户关联的组信息列表") @ApiImplicitParams(value = {
      @ApiImplicitParam(name = "userId", value = "用户id", required = true, dataType = "long", paramType = "query"),
  ...
  @Override public Response<List<GroupDto>> listGroupsRelateToUser(GroupQuery query) {
  ...
  @Override public Response<PageDto<GroupDto>> queryTotalInfo(GroupParam groupParam) {
    return Response.success(groupService.queryTotalInfo(groupParam.getId(), groupParam.getCode(),
        ...
        groupParam.getNeedGrpUserRole(), groupParam.getNeedGrpUserTag(), groupParam.getNeedGrpUserExtendVal(), groupParam.getPageNumber(),
