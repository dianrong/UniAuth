...
public interface CallerPermissionMapper {
     ...
     * @mbggenerated Mon Jan 23 17:45:27 CST 2017
     */
    int updateByExampleSelective(@Param("record") CallerPermission record, @Param("example") CallerPermissionExample example);
     ...
     * @mbggenerated Mon Jan 23 17:45:27 CST 2017
     */
    int updateByExample(@Param("record") CallerPermission record, @Param("example") CallerPermissionExample example);
}