...
//        List<Person> lists = ldapTemplate.search(query().where("cn").is("admin"), new PersonAttributesMapper());
...
//        List<User> u = ldapTemplate.search(query().base("cn=users").where("uid").is("wangw"), new UserAttributesMapper());
//        System.out.println(u);
//    }

//    @Test
//    public void addPersonsTest() {
//        Person copyOne = ldapTemplate.search(query().base("cn=users").where("uid").is("wangw"), new PersonAttributesMapper()).get(0);
