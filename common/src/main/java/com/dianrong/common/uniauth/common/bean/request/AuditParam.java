...
public class AuditParam extends PageParam {
    ...
    public String toString() {
        return "AuditParam [userId=" + userId + ", minRequestDate=" + minRequestDate + ", maxRequestDate=" + maxRequestDate + ", domainId=" + domainId + ", reqIp=" + reqIp + ", reqUuid=" + reqUuid
                + ", reqUrl=" + reqUrl + ", reqSequence=" + reqSequence + ", reqClass=" + reqClass + ", reqMethod=" + reqMethod + ", reqSuccess=" + reqSuccess + ", reqException=" + reqException
                + ", minReqElapse=" + minReqElapse + ", maxReqElapse=" + maxReqElapse + ", reqParam=" + reqParam + ", reqResult=" + reqResult + ", orderBy=" + orderBy + ", ascOrDesc=" + ascOrDesc
                + ", requestDomainCode=" + requestDomainCode + "]";
    }
}
