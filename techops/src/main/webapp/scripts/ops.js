require(['app',
    ...
    'controllers/organization/organization-add',
    'controllers/organization/organization-modify',
    'controllers/organization/organization-move',
    'controllers/organization/organization-delete',
    'controllers/organization/organization-add-user',
    'controllers/organization/organization-delete-user',
    'controllers/organization/organization-move-user',
    'controllers/organization/organization-add-owner',
    'controllers/organization/organization-delete-owner',
    'controllers/organization/organization-move-owner',
    ...
    'controllers/synchronous/synchronous',
    ...
    'services/synchronous/synchronous-service',
