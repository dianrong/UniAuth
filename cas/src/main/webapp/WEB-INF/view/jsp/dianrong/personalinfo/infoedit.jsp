		...
		<div class="common-wizard infoedit paddingtop10">
				...
				<form class="form-horizontal">
					<div class="form-group">
						...
						<label  class="col-sm-5 control-label infolabel  info_name_show">${fn:escapeXml(userinfo.name)}</label>
						...
						<div class="col-sm-5 info_name_edit hidden-element">
							 <input type="text" class="form-control  col-sm-5" id="inputPhone" placeholder="<spring:message code="screen.personal.info.edit.label.phone"/>"
								name="phone" value="${fn:escapeXml(userinfo.name)}">
						</div>
						...
						<div class="col-sm-1 info_name_edit hidden-element">
					...
					<!-- email -->
					<div class="form-group">
						<label for="inputEmail" class="col-sm-3 control-label"><spring:message code="screen.personal.info.edit.label.email" /></label>
						<label id="inputEmail" class="col-sm-5 control-label infolabel">${fn:escapeXml(userinfo.email)}</label>
						<div class="col-sm-1">
					...
					<!-- phone -->
					<div class="form-group">
						<label for="inputEmail" class="col-sm-3 control-label"><spring:message code="screen.personal.info.edit.label.phone" /></label>
						<label id="inputEmail" class="col-sm-5 control-label infolabel">${fn:escapeXml(userinfo.phone)}</label>
						<div class="col-sm-1">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
      		<form action="" class="form-horizontal">
      			<div class="update-email-step1">
					<div class="form-group">
							<label  for="update-email-original-email" class="col-sm-offset-1 col-sm-2 control-label"><spring:message code="screen.personal.info.edit.label.email" /></label>
							<label  class="col-sm-8 control-label infolabel">${fn:escapeXml(userinfo.email)}</label>
					</div>
					<div class="form-group">
							<label for="update-email-captcha" class="col-sm-offset-1 col-sm-2 control-label"><spring:message code="screen.personal.info.edit.updateemail.label.captcha" /></label>
							<div class="col-sm-4">
				...
				<div class="update-email-step2 hidden-element">
					<div class="form-group">
							<label  for="update-email-original-email" class="col-sm-offset-1 col-sm-2 control-label"><spring:message code="screen.personal.info.edit.label.email" /></label>
							<label  class="col-sm-8 control-label infolabel">${fn:escapeXml(userinfo.email)}</label>
					</div>
				...
				<div class="form-group">
						<div class="col-sm-offset-3 col-sm-10 showwarninfo">
				...
				<div class="update-email-step1">
					<div class="form-group">
						<div class="col-sm-offset-3 col-sm-6">
							<button type="button" class="btn btn-success btn-wide"  id="update_email_btn_step1" >
								<spring:message code="screen.personal.info.edit.updateemail.btn.step1"/>
							</button>
						</div>
					</div>
				</div>
				<div class="update-email-step2 hidden-element">
						<div class="form-group">
							<div class="col-sm-offset-3 col-sm-6">
								<button type="button" class="btn btn-success btn-wide"  id="update_email_btn_confirm" >
