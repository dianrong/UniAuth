...
public final class PermissionUtil {
    ...
    public static final void mergeIPAPermission(IPAPermissionDto ipaPermissionDto, Collection<GrantedAuthority> authorities, Map<String, Set<String>> permMap,
        ...
        if (ipaPermissionDto != null && ipaPermissionDto.getRoleList() != null && !ipaPermissionDto.getRoleList().isEmpty()) {
     ...
     * 合并权限
     */
    public static final void mergeDomainPermission(List<RoleDto> roleDtoList, Collection<GrantedAuthority> authorities, Map<String, Set<String>> permMap,
            Map<String, Set<PermissionDto>> permDtoMap) {
        if (authorities == null || permDtoMap == null || permMap == null) {
