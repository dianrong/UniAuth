...
public class UserExtInfo implements UserDetails {
    ...
    private SingleDomainUserExtInfo getCurrentDomainUserExtInfo() {
        ...
        if (currentDomainUserExtInfo == null) {
            SingleDomainUserExtInfo emptyUserInfo = SingleDomainUserExtInfo.emptyAuthorityUserInfo(this.loginDomainUserExtInfo.getUsername(), this.loginDomainUserExtInfo.getId(),
                    this.loginDomainUserExtInfo.getUserDto(), new DomainDto().setCode(DomainDefine.getStaticDomainCode()), this.allDomainPermissionDto);
            // cache
    ...
    public UserExtInfo(String username, String password, boolean enabled, boolean accountNonExpired, boolean credentialsNonExpired, boolean accountNonLocked,
        ...
        this(username, password, enabled, accountNonExpired, credentialsNonExpired, accountNonLocked, authorities, id, userDto, domainDto, permMap, permDtoMap,
    ...
    public UserExtInfo(String username, String password, boolean enabled, boolean accountNonExpired, boolean credentialsNonExpired, boolean accountNonLocked,
        ...
        this.loginDomainUserExtInfo = new SingleDomainUserExtInfo(username, password, enabled, accountNonExpired, credentialsNonExpired, accountNonLocked, authorities, id, userDto,
     ...
     */
    public static UserExtInfo build(UserExtInfoParam currentLoginDomainUserInfo, Map<String, UserExtInfoParam> userExtInfos, AllDomainPermissionDto ipaPermissionDto) {
